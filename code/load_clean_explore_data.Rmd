...
png(file = "../figures/Correlation_plot_c_relevant.png")
corrplot(corr_matrix_c_relevant,type = "upper")
# primary dataset
png(file = "../figures/Correlation_plot_p_relevant.png")
...
## Detecting outliers
```{r}
mod <- lm(salary ~ .-salary-name-Pos, data=df_final_relevant)
