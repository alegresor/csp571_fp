...
# train/test Simple Linear Regression models
ignore <- lre_modeling('primary',x_train.p,y_train.p,x_test.p,y_test.p,seq(0,1,by=.1),TRUE)
ignore <- lre_modeling('complete',x_train.c,y_train.c,x_test.c,y_test.c,seq(0,1,by=.1),TRUE)
```
...
saveRDS(optimal_model,file='optimal_model.rds')
df_p.all[df_p.all['name']=='lebron james',]
```
